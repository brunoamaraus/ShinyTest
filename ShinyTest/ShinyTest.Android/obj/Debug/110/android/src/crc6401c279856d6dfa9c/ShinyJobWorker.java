...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Shiny.Jobs.ShinyJobWorker, Shiny.Jobs", ShinyJobWorker.class, __md_methods);
	}
	...
	public ShinyJobWorker (android.content.Context p0, androidx.work.WorkerParameters p1)
	{
		...
		if (getClass () == ShinyJobWorker.class)
			mono.android.TypeManager.Activate ("Shiny.Jobs.ShinyJobWorker, Shiny.Jobs", "Android.Content.Context, Mono.Android:AndroidX.Work.WorkerParameters, Xamarin.AndroidX.Work.Runtime", this, new java.lang.Object[] { p0, p1 });
	}
